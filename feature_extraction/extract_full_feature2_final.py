...
def process_file(file):
    dict_path = '../dataset/csvFile/eSol_train.csv'
    name_dict = name_label_dict(dict_path)
    seq_dict = name_seq_dict(dict_path)

    # 设置文件路径
    pdb_directory = "../dataset/train_data/pdbTrain"
    fasta_directory = "../dataset/train_data/fastaTrain"
    pkl_directory = "../dataset/train_data/pkl"
    esmc_directory = "../dataset/train_data/esmc"  # 新增ESMC目录
    dssp_directory = "../dataset/train_data/dssp"  # 新增DSSP目录
    extra_feat_directory = "../dataset/train_data/extra_feat"

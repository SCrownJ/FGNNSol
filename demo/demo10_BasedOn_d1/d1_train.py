...
for epoch in range(1, epochs + 1):
    ...
    if test_accuracy < best_loss:
        ...
        torch.save(model.state_dict(), "/new/songguanjie/GeoPoc/check_point/demo10_BasedOn_d1/best_model5.pt")
    print(
...
model.load_state_dict(torch.load("/new/songguanjie/GeoPoc/check_point/demo10_BasedOn_d1/best_model5.pt"))
model.eval()
...
df.to_csv("/new/songguanjie/GeoPoc/check_point/demo10_BasedOn_d1/Rov5.csv", index=False)

...
# train_path = "/new/songguanjie/GeoPoc/dataset/train_data/pkl"
# test_path = "/new/songguanjie/GeoPoc/dataset/test_data/pkl"
# val_path = "/new/songguanjie/GeoPoc/dataset/val1_scere_data/pkl"
# val1_path = "/new/songguanjie/GeoPoc/dataset/val2_371_data/pkl"


train_path = "../../dataset/train_data/pkl"
test_path = "../../dataset/test_data/pkl"
val_path = "../../dataset/val1_scere_data/pkl"
val1_path = "../../dataset/val2_371_data/pkl"
...
node_dim = 1181 + 184  # 输入特征的维度*
edge_in_channels = 450
extra_feat_dim = 16
hidden_channels = 256  # 隐层特征的维度
dropout = 0     # 最好的是0，在_1中还是0，_2中改为0.1
gcn_num_layers = 4  # 网络层数
gat_num_layers = 2

# 创建模型实例
model = GATGCN(node_dim, edge_in_channels, hidden_channels, extra_feat_dim, gcn_num_layers, gat_num_layers, dropout, device).to(device)
...
for epoch in range(1, epochs + 1):
    ...
    if test_accuracy < best_loss:
        ...
        torch.save(model.state_dict(), "/new/songguanjie/GeoPoc/check_point/demo11_BasedOn10/best_model1.pt")
    print(
        f'Epoch: {epoch}, Train_Loss: {train_accuracy:.8f}, Test_Loss: {test_accuracy:.8f}, ValLoss: {val_accuracy:.8f}, Val1Loss: {val1_accuracy:.8f}')

# print('Seed = ' +  str(seed) + ' Training finished.')


model.load_state_dict(torch.load("/new/songguanjie/GeoPoc/check_point/demo11_BasedOn10/best_model1.pt"))
model.eval()
...
df.to_csv("/new/songguanjie/GeoPoc/check_point/demo11_BasedOn10/Rov1.csv", index=False)
